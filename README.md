...
![image](https://user-images.githubusercontent.com/60611845/212537029-0f99026d-d7ab-4ade-824e-b726fbe05b6f.png)
...
Тестирование CD выполенены на @playwright/test на сервисе Checkly. 
  Github отправляет информацию, на хостинг Versel, далее Versel обращается к Checkly, где записаны наши тесты, которые проверяют фронтенд составляющею: Отрисовку страницы и работоспособность кнопок. Затем Checkly датет ответ если тесты пройдены, и далее мы получаем финальный результат.
